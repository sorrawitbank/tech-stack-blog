...
const styles: Record<ButtonVariant, string> = {
  ...
  text: "flex justify-center items-center gap-1.5 text-body-1 text-center underline text-brown-600 transition-colors duration-200 cursor-pointer hover:text-brown-400 active:text-brown-500 disabled:opacity-40",
};
