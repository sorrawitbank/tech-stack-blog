...
const variants: Record<ButtonVariant, string> = {
  ...
  secondary:
    "flex justify-center items-center gap-1.5 h-12 px-10 py-3 text-body-1 text-center text-brown-600 bg-white border border-brown-400 rounded-full transition-colors duration-200 cursor-pointer hover:text-brown-400 active:text-brown-500 disabled:border-brown-600 disabled:opacity-40",
