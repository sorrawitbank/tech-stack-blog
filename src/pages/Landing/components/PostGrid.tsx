...
function PostGrid() {
  ...
  if (paginatedPosts.length === 0) {
    ...
    if (error)
      return (
        <div className="flex flex-col items-center gap-2 mb-[calc(100svh-37rem)] sm:mb-[calc(100svh-41rem)]">
    ...
    return (
      <div className="flex flex-col items-center gap-2 mb-[calc(100svh-37rem-28px)] sm:mb-[calc(100svh-41rem-28px)]">
